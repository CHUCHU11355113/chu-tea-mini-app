...
const AdminSystemConfigs = lazy(() => import("./pages/admin/SystemConfigs"));
...
{/* 后台管理 */}
      ...
      <Route path="/admin/system-configs" component={() => <AdminLayout><AdminSystemConfigs /></AdminLayout>} />
      <Route path="/admin/business-rules" component={() => <AdminLayout><AdminBusinessRules /></AdminLayout>} />
